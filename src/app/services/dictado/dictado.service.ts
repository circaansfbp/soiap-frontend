...
export class DictadoService {
  ...
  // Iniciar grabación 
  start() {
    this.toastr.info('Ahora puede comenzar a dictar la información que desea registrar. Recuerde esperar al menos 2 segundos para asegurar el correcto registro de esta.', 'Escuchando...');
